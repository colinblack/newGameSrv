package com.sanguo.game.server.connectlogic.common.message.ProtoUser
{
	...
	public class BuildingsCPP
	{
		public static const PROTO:String = "ProtoUser.BuildingsCPP";
		...
		public function BuildingsCPP(root:*)
		{
			package_root = root;
		...
		public function unserialize(msgObj:*):BuildingsCPP
		{
			ud = undefined;
			buildId = undefined;
			position = new Vector.<int>();
		...
		public function decode(buffer:*):BuildingsCPP
		{
